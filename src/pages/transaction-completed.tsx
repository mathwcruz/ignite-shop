...
} from "@/styles/pages/transaction-completed";
  ...
  return (
    <>
      ...
      <TransactionCompletedContainer>
        ...
        <ImageContainer>
          <Image
            src={session.shirt?.imageUrl}
            width={120}
            height={110}
            alt={session.shirt?.name}
          />
        </ImageContainer>

        <p>
          Woo-hoo, <strong>{session.customer?.name}</strong> your{" "}
          <strong>{session.shirt?.name}</strong> is on its way to your home.
        </p>
